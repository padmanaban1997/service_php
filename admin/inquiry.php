                 ...
                 <div class="span12">
                     ...
                     <div class="widget purple">
                         <div class="widget-title">
                             <h4><i class="icon-reorder"></i> Inquiry </h4>
                            <span class="tools">
    ...
    exit();
	 ...
	 while($row = mysqli_fetch_array($result))
	 {
		...
		// echo "<td>" . $row['ans'] . "</td>";
		 ...
		 if($row['done']==0)
					{
						//echo "<a href=\"response.php?id=$row[i_id]\"><img src=\"image\Reply.jpg\" height=''/></a>
						echo "<a href=\"inquirydelete.php?id=$row[i_id]\"><img src=\"image\delete.jpg\" height=''/></a>";
					}
					else
					{
						echo "<img src=\"image\accept.jpg\">&nbsp; &nbsp;<a href=\"inquirydelete.php?id=$row[i_id]\"><img src=\"image\delete.jpg\" height=''/></a>";
					}
