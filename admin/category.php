   ...
   <div id="container" class="row-fluid">
                     ...
                     <div class="widget purple">
                         ...
                         <div class="widget-body">
                             <div>
                                 <div class="clearfix">
                                     <div class="btn-group">
                                         <a href='categoryinsert.php'><button id="" class="btn green">
    ...
    exit();
	 ...
	 while($row = mysqli_fetch_array($result))
	 {
		 ...
		 echo "<td><a href=\"categorydelete.php?id=$row[id]\"><img src=\"image\delete.jpg\" height=''/></a> &nbsp; &nbsp;
		 
			<a href=\"categoryupdate.php?id=$row[id]\"><img src=\"image\update.jpg\" height=''/></a>
</td>";
		 echo "</tr>";
	 }
