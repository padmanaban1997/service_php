...
if ($_SERVER["REQUEST_METHOD"]=="POST") {
	...
	$query = "update admin set otp_used = 1, 
               ...
               <form id="resetform" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                  <div class="form-group"> 
					  ...
					  <div class="input-icon">
                         ...
                         <input type="password" name="password" id="password"  class="form-control rounded-0 py-3 pl-5 font-13 sign-register-input" placeholder="New Password">
                      </div>
					  <div class="input-icon">
                         <span class="fables-iconpassword fables-input-icon font-19 mt-1"></span>
                         <input type="password" name="password_confirm"  class="form-control rounded-0 py-3 pl-5 font-13 sign-register-input" placeholder="Confirm Password">
                      </div>
